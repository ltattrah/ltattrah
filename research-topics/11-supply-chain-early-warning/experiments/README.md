...
Phases:
1. Phase A — As-of-date data (Days 1–30) — feasibility gate
2. Phase B — Modelling (Days 25–55)
3. Phase C — Budgeted evaluation (Days 45–80)
4. Phase D — Label uncertainty (Days 70–90)

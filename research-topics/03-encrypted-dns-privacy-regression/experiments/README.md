...
Phases:
1. Phase A — Threat model and testbed (Days 1–25)
2. Phase B — Impairment matrix (Days 20–55)
3. Phase C — Instrumentation and state classification (Days 35–65)
4. Phase D — State-aware policy and validation (Days 55–90)

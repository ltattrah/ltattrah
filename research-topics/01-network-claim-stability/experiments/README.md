...
Phases:
1. Phase A — Corpus construction (Days 1–20)
2. Phase B — Cross-backend re-execution (Days 15–55)
3. Phase C — Claim Stability Index (Days 40–70)
4. Phase D — Second-host validation and decomposition (Days 60–90)

...
Phases:
1. Phase A — Sampler design and cost model (Days 1–30)
2. Phase B — Estimators (Days 20–45)
3. Phase C — Equal-budget evaluation (Days 35–75)
4. Phase D — Transfer and robustness (Days 65–90)
